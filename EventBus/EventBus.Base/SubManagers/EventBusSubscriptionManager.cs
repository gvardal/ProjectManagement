...
namespace EventBus.Base.SubManagers
{
    public class EventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        public void RemoveSubscription<T, TH>()
            ...
            where TH : IIntegrationEventHandler<T>
        {
            var handlerToremove = FindSubscriptionForRemove<T, TH>();
            var eventName = GetEventKey<T>();
        ...
        private SubscriptionInfo FindSubscriptionForRemove<T,TH>() where T : IntegrationEvent where TH: IIntegrationEventHandler<T>
        {
            var eventName = GetEventKey<T>();
