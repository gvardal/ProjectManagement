        ...
        public void Configure(EntityTypeBuilder<KanbanCard> builder)
        {
            ...
            builder.HasData
                (
                    ...
                    new KanbanCard { Id = 5, Title = "BLAZ-29005", Status = "Review", Summary = "Fix the issues reported by the customer.", Assignee = "Steven walker" },
                    new KanbanCard { Id = 6, Title = "BLAZ-29006", Status = "Review", Summary = "Fix the issues reported in Safari browser.", Assignee = "Nancy Davloio" },
                    ...
                    new KanbanCard { Id = 8, Title = "BLAZ-29008", Status = "Validate", Summary = "Validate the issues reported by the customer.", Assignee = "Steven walker" },
                    ...
                    new KanbanCard { Id = 11, Title = "BLAZ-29011", Status = "Review", Summary = "Fix the issues reported in data binding.", Assignee = "Janet Leverling" },
                    new KanbanCard { Id = 12, Title = "BLAZ-29012", Status = "Close", Summary = "Analyze SQL server 2008 connection.", Assignee = "Andrew Fuller" },
                    new KanbanCard { Id = 13, Title = "BLAZ-29013", Status = "Validate", Summary = "Validate databinding issues.", Assignee = "Margaret hamilt" },
                    ...
                    new KanbanCard { Id = 17, Title = "BLAZ-29017", Status = "Validate", Summary = "Validate editing issues.", Assignee = "Nancy Davloio" },
                    new KanbanCard { Id = 18, Title = "BLAZ-29018", Status = "Review", Summary = "Test editing functionality.", Assignee = "Nancy Davloio" },
                    ...
                    new KanbanCard { Id = 22, Title = "BLAZ-29022", Status = "Review", Summary = "Fix the editing issues reported by the customer.", Assignee = "Janet Leverling" },
